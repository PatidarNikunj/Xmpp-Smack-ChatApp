...
public class MyXMPP {
    ...
    public MyXMPP(MyService context, String serverAdress, String hostName, String logiUser,
                  String passwordser) {
    ...
    public static MyXMPP getInstance(MyService context, String server, String host,
                                     String user, String pass) {

        if (instance == null) {
            instance = new MyXMPP(context, server, host, user, pass);
    ...
    public void sendMessage(ChatMessage chatMessage) {
        ...
        try {
            ...
            Log.e("xmpp.SendMSG-Exception", "msg Not sent!" + e.getMessage());
        }
...
//                Log.i(TAG, "processMessage: " + gson.fromJson(message.getBody(), ChatMessage.class));
